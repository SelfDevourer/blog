                ...
                <div class="row" id="blog">
                    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-offset-3 col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">Technology Blog</div> 
                            <div class="list-group">
                                <a href="cn/2017/04/28/Space_Shooter.html" class="list-group-item">小游戏——Space Shooter</a>
                            </div>
                            <div class="list-group">
                                <a href="cn/2017/03/19/I_Have_Special_Racing_Skills.html" class="list-group-item">我有特殊的飙车技巧</a>
                            </div>
                            <div class="list-group">
                                <a href="cn/2017/01/16/high_language_programming.html" class="list-group-item">高级语言程序设计</a>
                            </div>
                            <div class="list-group">
                                <a href="cn/2016/12/10/Maven_Build_SSM.php" class="list-group-item">Maven搭建SSM</a>
                            </div>
                            <div class="list-group">
                                <a href="cn/2016/12/07/Maven_Install_And_Config.php" class="list-group-item">Maven安装和配置</a>
                            </div>
                        </div>
                    </div>
                </div>
